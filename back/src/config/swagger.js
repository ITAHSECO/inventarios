    ...
    components: {
      ...
      schemas: {
        ...
        Conteo: {
          ...
          properties: {
            id: { type: 'integer' },
            barrido_id: { type: 'integer', nullable: true, description: 'FK al barrido' },
            barrido: { type: 'string', description: 'Nombre del barrido' },
            codigo: { type: 'string', description: 'Código del artículo' },
